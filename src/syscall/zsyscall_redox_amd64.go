...
//go:cgo_import_static _cgo_libc_getpgid
//go:cgo_import_static _cgo_libc_getpid
//go:cgo_import_static _cgo_libc_getpgrp
...
//go:linkname libc_Getpgid _cgo_libc_getpgid
//go:linkname libc_Getpid _cgo_libc_getpid
//go:linkname libc_Getpgrp _cgo_libc_getpgrp
...
func Close(fd int) (err error) {
	_, _, e1 := rawsyscgocall6(unsafe.Pointer(&libc_Close), 1, uintptr(fd), 0, 0, 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	if err == nil {
...
func Getpgid(pid int) (pgid int, err error) {
	r0, _, e1 := rawsyscgocall6(unsafe.Pointer(&libc_Getpgid), 1, uintptr(pid), 0, 0, 0, 0, 0)
	pgid = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func Getpgrp() (pgrp int) {
	r0, _, _ := rawsyscgocall6(unsafe.Pointer(&libc_Getpgrp), 0, 0, 0, 0, 0, 0, 0)
	pgrp = int(r0)
	return
}
